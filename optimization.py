...
"""
def L_layer_model_GD(X, Y, layers_dims,initialization, A_layers , A_out ,learning_rate=0.0075, num_iterations=1000,  print_cost=True):
    Y = np.transpose(Y)
    np.random.seed(1)
...
def L_layer_model_SGD(X, Y, layers_dims,initialization, A_layers , A_out ,learning_rate=0.0075, num_iterations=1000,  print_cost=True):
...
def L_layer_model_GDWithMomentum(X, Y, layers_dims,initialization, A_layers , A_out ,beta=0.9,learning_rate=0.0075, num_iterations=1000,  print_cost=True):
    Y = np.transpose(Y)
    np.random.seed(1)
    costs = []  # keep track of cost
...
def L_layer_model_Adam(X, Y, layers_dims,initialization, A_layers , A_out ,beta1 = 0.9, beta2 = 0.999,  epsilon = 1e-8,learning_rate=0.0075,
...
def L_layer_model_minibatch(X, Y, layers_dims, optimizer,initialization, A_layers , A_out, mini_batch_size=64,learning_rate=0.0007, beta=0.9,
